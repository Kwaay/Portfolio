<?php include('pages/header.php'); ?>
        <section id="presentation">
            <div class="presentation-presentation">
                <div class="reseau-container">
                    <div class="reseau-github">
                        <img src="images/logos/github-logo.png" alt="Logo GitHub">
                        <a href="https://github.com/Kwaay" target=”_blank class="reseau-name">GitHub</a>
                    </div>
                    <div class="reseau-linkedin">
                        <img src="images/logos/linkedin-logo.png" alt="Logo LinkedIn">
                    ...
                    <div class="reseau-twitter">
                        <img src="images/logos/twitter-logo.png" alt="Logo Twitter">
                        <a href="https://twitter.com/dev_ben_" target=”_blank class="reseau-name">Twitter</a>
                    </div>
                </div>
                <div class="img">
            ...
            <div class="presentation-text">
                <p>
                    Nullam sed nisi dictum ex rhoncus pharetra. Suspendisse fermentum arcu quis pharetra fringilla. Nulla consectetur metus a nisl fermentum, vel sodales diam porttitor. Phasellus bibendum interdum sem, ut malesuada orci. Vestibulum posuere cursus maximus. Donec et odio vitae urna pellentesque pretium. Aenean venenatis erat at gravida ullamcorper.

                    Aliquam et faucibus massa. Nunc ac scelerisque lacus. Proin sed viverra neque. Integer at urna laoreet, dapibus massa a, porttitor nulla. Pellentesque quis vehicula augue, at gravida sem. Morbi ut pharetra felis, efficitur eleifend sapien. Proin porta diam lorem, at eleifend dolor condimentum ut. Praesent eget diam a arcu elementum mollis ac quis sem. Proin mattis aliquet mi, vitae luctus lacus aliquet eget.

                    Interdum et malesuada fames ac ante ipsum primis in faucibus. Pellentesque sit amet posuere eros, sed fermentum odio. Phasellus sollicitudin risus eu pulvinar interdum. Sed accumsan quis lorem ut blandit. Phasellus volutpat lacus a purus placerat, in bibendum nisi consequat. Phasellus vel diam at erat blandit blandit. Aenean a viverra sapien. Vestibulum eget sapien id turpis varius pretium. Vivamus eu velit at ipsum tristique faucibus. Aliquam iaculis at felis et faucibus. Nam augue ipsum, porta id rhoncus id, malesuada non lorem. Mauris non magna a ante aliquet consequat feugiat vitae elit. Aenean pulvinar ligula a eros suscipit, lacinia egestas erat accumsan. Phasellus egestas et massa nec lacinia.

                    Curabitur molestie pulvinar nulla eu interdum. Donec luctus molestie ipsum, non condimentum nisl accumsan at. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Sed tortor ligula, dignissim a dapibus at, bibendum ac leo. Duis vulputate porttitor tellus eleifend facilisis. Fusce laoreet convallis laoreet. Nam eget dapibus nulla. Duis molestie nisi quis sem maximus, ut hendrerit dui feugiat. Pellentesque in sagittis velit, sit amet vestibulum nisi. Praesent non semper mi. Etiam eu lorem non tellus hendrerit interdum. Nullam porta molestie posuere. Integer sit amet eros in turpis porttitor ornare id et ex. Sed felis erat, vulputate a nisi ac, hendrerit vulputate libero.

                    Praesent faucibus cursus enim, sit amet pharetra sem. Suspendisse a consequat turpis, a finibus lectus. Integer viverra ultricies risus, sed viverra leo iaculis non. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vivamus dapibus nisl ac magna ultricies ultricies. Morbi dapibus lobortis ullamcorper. Praesent augue erat, pretium at viverra id, tempor nec massa. Integer pharetra justo sed tortor rhoncus, varius gravida eros blandit. Suspendisse potenti.
                </p>
            </div>
        </section>
        <br />
        ...
        <section id="formations">
            <div class="formation-container-prep">
                <div class="formation-prep-fullstack">
                    <h2><img src="images/logos/oc-logo.png" alt="Logo OpenClassrooms" width="60px" height="60px">Formation "Prep'FullStack"</h2>
                    <p>
                    ...
                    <ul>
                        <li>Adapter un thème WordPress</li>
                        <li>Coder la structure d’une page en HTML5</li>
                        <li>Modéliser une base de données</li>
            ...
            <br />
            <div class="formation-container-web">
